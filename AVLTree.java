...
public class AVLTree {
	...
	/**Rotates the tree right on x-y edge*/
	 ...
	 * if the key already exists - returns an external leaf
	 */
	...
	/**diagnoses if there is a problem with where's height
	 * if there is a problem - the function returns which type is it
	 */
	 ...
	 * if it doesn't exist returns an external leaf */
	...
	/** fixes min and max after insertion	 */
	...
	/** 
	 * fixes min and max after deletion	 */
	...
	/**
	 * finds the node with height <= a on the right side of tree
	 */
	...
	/**
	 * finds the node with height <= a on the left side of tree
	 */
	...
	/**
	 * joins 2 trees with the same height 
	 * the root of the new tree will be x
	 */
	...
	/** 
	 * joins 2 trees with different height in the correct place
